...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var options = {
    ...
    prevNextButtons: true, // Affiche les boutons "précédent" et "suivant"
    pageDots: true, // Affiche les indicateurs de pagination (les petits points)
    setGallerySize: false, // Empêche Flickity d'ajuster automatiquement la hauteur du slider
    autoPlay: 4000, // Active le défilement automatique toutes les 3 secondes
    pauseAutoPlayOnHover: true, // Met en pause l'autoplay lorsque la souris survole le slider
    wrapAround: true, // Permet de revenir au premier slide après le dernier (boucle infinie)
